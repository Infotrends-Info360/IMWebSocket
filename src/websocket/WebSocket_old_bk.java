...
//
//public class WebSocket_old_bk extends WebSocketServer {
//	public WebSocket_old_bk(InetSocketAddress address) {
//		super(address);
//		System.out.println("IP address: " + address);
//	}
//
//	public WebSocket_old_bk(int port) throws UnknownHostException {
...
//		synchronized (keySet) {
//			for (String key : keySet) {
//				// 若有"heartbeat"的key,代表這個send是由Client發出的
